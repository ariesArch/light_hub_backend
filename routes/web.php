...
use App\Http\Controllers\Admin\CategotyProductController;
...
use App\Http\Controllers\Admin\UserCommunityController;
...
Route::middleware([
    ...
    Route::resource('user_communities', UserCommunityController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('societies', SocietyController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('product_categories', ProductCategoryController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('variations', VariationController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('products', ProductController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('category_products', CategotyProductController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('blogs', BlogController::class, ['except' => ['store', 'update', 'destroy']]);
    Route::resource('blog_categories', BlogCategoryController::class, ['except' => ['store', 'update', 'destroy']]);
});
